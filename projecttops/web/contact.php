                       ...
                       <div class="container">
                          <Form action="" method="post">
                            <div class="form-group">
                              Name:<input type="text" class="email-bt" placeholder="Name" name="Name">
                            </div>
                            <div class="form-group">
                              Pno:<input type="number" class="email-bt" placeholder="Phone Numbar" name="Pno">
                            </div>
                            <div class="form-group">
                              Email:<input type="text" class="email-bt" placeholder="Email" name="Email">
                            </div>
                            
                            <div class="form-group">
                                Massage<textarea class="massage-bt" placeholder="Massage" rows="5" id="comment" name="Massage"></textarea>
                            </div>
