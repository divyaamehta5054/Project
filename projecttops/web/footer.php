    	...
    	<div class="container">
    		<div class="mail_section">
    			<div class="row">
    				...
    				<div class="col-sm-6 col-lg-2">
    					<div class="footer-logo"><img src="images/phone-icon.png"><span class="map_text">(91) 7096612944</span></div>
    				</div>
    				<div class="col-sm-6 col-lg-3">
    					<div class="footer-logo"><img src="images/email-icon.png"><span class="map_text">divya123@gmail.com</span></div>
    				</div>
    				<div class="col-sm-6 col-lg-3">
